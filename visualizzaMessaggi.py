...
nomeFileUtenti="C:\\224MI\\Progetti\\Whatsapp2.0\\utenti.csv"
...
if ('accessoEseguito' in st.session_state 
    ...
    if len(response['selected_rows'])>0:
        ...
        nomeFileMessaggi="C:\\224MI\\Progetti\\Whatsapp2.0\\messaggi.csv"
        ...
        listaMessaggiFiltrata=listaMessaggi.loc[listaMessaggi[nomeColDestinatario] == destinatarioMessaggio]
